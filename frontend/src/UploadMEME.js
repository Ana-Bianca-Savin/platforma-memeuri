                    ...
                    <div className="card-body">
                        <div className="row align-items-center p-3">
                            ...
                            <div className="col">
                                <div className="col">
                                    <form action="">
                                        <label htmlFor="desc" className="form-label forms-title">Descriere</label>
                                        <input id="desc" type="text" className="form-control formBox" 
                                        placeholder="descriere" required/>

                                        <label htmlFor="MEME" className="form-label forms-title mt-3">Meme(jpg, jpeg, png, gif)</label>
